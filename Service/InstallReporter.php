<?php
/**
 * Standalone install + heartbeat reporter for Panth_CheckoutExtended.
 *
...
namespace Panth\CheckoutExtended\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_CheckoutExtended';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-checkout-extended';
